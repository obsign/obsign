...
//!
//! A thin wrapper over the shared [`pkcs11::Pkcs11Signer`]: the FFI, the token
...
pub use pkcs11::TokenSelector;

fn map(e: pkcs11::Error) -> Error {
...
impl Pkcs11Sealer {
    pub fn open(
        ...
        let inner =
            pkcs11::Pkcs11Signer::open(module, token, pin, key_label, key_id).map_err(map)?;
        Ok(Pkcs11Sealer {
            inner,
